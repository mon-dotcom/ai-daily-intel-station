...
| denova | [官方連結](https://github.com/alfredxw/denova) | An AI creative platform for novel writing and story-driven games, with built-in support for AI agents, Skills, subagent workflows, automations, and version control. | 自動化工作流、agent 任務執行、工具串接 | 中 |
